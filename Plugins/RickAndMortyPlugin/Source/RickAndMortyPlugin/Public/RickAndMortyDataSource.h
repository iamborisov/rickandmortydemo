...
public:
    ...
    virtual void FindLatentAction_Create(UObject* WorldContextObject, URickAndMortyCharacter*& Result,
                                         struct FLatentActionInfo LatentInfo);
    ...
    virtual void CountLatentAction_Create(UObject* WorldContextObject, int32& Result,
                                          struct FLatentActionInfo LatentInfo);
