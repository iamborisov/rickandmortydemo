...
void URickAndMortyMockDataSource::Find(UObject* WorldContextObject, int32 Id, URickAndMortyCharacter*& Result, struct FLatentActionInfo LatentInfo)
{
    FindLatentAction_Create(WorldContextObject, Result, LatentInfo);
    
    URickAndMortyMockConfiguration* Configuration = URickAndMortyMockConfigurationFactory::CreateFromCurrentSettings(GetOuter());
